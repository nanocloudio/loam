...
| Decision-record payload | `MAX_INNER` | `replicated/loam_decision_wire.rs` | 4096 | Policy: the largest loam record a Propose carries across the clustor envelope. Every metadata wire record is bounded under it by construction |
